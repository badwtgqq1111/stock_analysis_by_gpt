...
"""A 股数据 loader，连接 provider 与新数据层。"""

from pathlib import Path

from data.ingest.base import BaseMarketDataLoader
from data.ingest.providers import CNHistoryDataFetcher, CNStockInfoFetcher
...
class CNStockDataLoader(BaseMarketDataLoader):
    """A 股数据加载器。"""
    ...
    def fetch_history(self, stock_code, start_date=None, end_date=None, num_records=None, adjust="qfq", period="daily"):
        ...
        return normalize_ohlcv_frame(
            ...
            market="CN",
            exchange=infer_exchange(normalized_code, market="CN"),
            asset_type="equity",
