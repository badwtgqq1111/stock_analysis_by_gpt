...
KEEP_PATTERN='^(PATH|CLICKHOUSE_[A-Z_]+|TUSHARE_[A-Z_]*KEY|CN_INDUSTRY_RELAY[A-Z_]*|HF_TOKEN|DEEPSEEK_API_KEY|TAVILY_API_KEY|OPENAI_[A-Z_]+|ANTHROPIC_[A-Z_]+|HTTP_PROXY|HTTPS_PROXY|ALL_PROXY|NO_PROXY|LANG|LC_ALL|TZ|PYTHONPATH|UV_[A-Z_]+)='
